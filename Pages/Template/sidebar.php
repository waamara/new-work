    ...
    <ul class="side-menu">
        ...
        <li>
            ...
            <ul class="side-dropdown">
                <li><a href="divisions.html" data-page="divisions">
                    <i class='bx bx-grid-alt icon'></i> Divisions
                </a></li>
                <li><a href="fournissers.html" data-page="fournisseurs">
                    <i class='bx bx-user-pin icon'></i> Fournisseurs
                </a></li>
                <li><a href="banque.html" data-page="banque">
                    <i class='bx bx-building icon'></i> Banque
                </a></li>
                <li><a href="monnaie.html" data-page="monnaie">
                    <i class='bx bx-dollar-circle icon'></i> Monnaie
                </a></li>
                <li><a href="appel_offre.html" data-page="divisions">
        ...
        <li>
            <a href="#"><i class='bx bx-shield icon'></i> Amandements 
                <i class='bx bx-chevron-right icon-right'></i>
            </a>
            <ul class="side-dropdown">
                <li><a href="../Amandements/Amandement.php" data-page="soumission">
                    <i class='bx bx-file-blank icon'></i>Liste des Amandements
                </a></li>
            </ul>
        </li>
